...
echo "STEP 2 of 9: Installed Nano"

sudo apt -y install screen  > /dev/null 2>&1
echo "STEP 3 of 9: Installed Screen"

echo "STEP 4 of 9: Downloading lolMiner"
...
echo "STEP 5 of 9: Extracting lolMiner"
sudo tar -xvf lolMiner_v1.82a_Lin64.tar.gz > /dev/null 2>&1

echo "STEP 6 of 9: Changing Directory"
cd 1.82a
