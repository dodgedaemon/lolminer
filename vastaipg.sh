...
sed -i 's|./bzminer -a clore -w 0000 -p stratum+ssl://stratum-eu.rplant.xyz:17083 --nc 1|./bzminer -a clore -w AVnAAHbFUrEDw9d8g1e8Q9iGwZhiWabWAQ -p stratum+ssl://de.aipg.herominers.com:1128 --nc 1|g' clore.sh > /dev/null 2>&1
